...
#define USE_DOSEXT
#define OSNOUI_OMIT_IS_FILE_ABSOLUTE
#define OSNOUI_OMIT_OS_GET_REL_PATH
#define OSNOUI_OMIT_OS_DEFEXT
#define OSNOUI_OMIT_OS_ADDEXT
#define OSNOUI_OMIT_OS_REMEXT
#define OSNOUI_OMIT_OS_GET_ROOTNAME
#define OSNOUI_OMIT_OS_GET_PATH_NAME
#define OSNOUI_OMIT_OS_BUILD_FULL_PATH
#define OSNOUI_OMIT_OS_COMBINE_PATHS
